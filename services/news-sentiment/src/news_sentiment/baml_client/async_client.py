...
class BamlAsyncClient:
    ...
    async def ExtractSentimentScores(
        self,
        news: str,
        baml_options: BamlCallOptions = {},
    ) -> types.SentimentScores:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.ExtractSentimentScores(
                news=news, baml_options=baml_options
            )
            ...
            result = await self.__options.merge_options(
                ...
                function_name='ExtractSentimentScores',
                args={
                    'news': news,
                },
            )
...
class BamlStreamClient:
    ...
    def ExtractSentimentScores(
        self,
        news: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.SentimentScores, types.SentimentScores]:
        ...
        return baml_py.BamlStream[stream_types.SentimentScores, types.SentimentScores](
            result,
            lambda x: typing.cast(
                stream_types.SentimentScores,
